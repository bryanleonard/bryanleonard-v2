...
<div class="containerZ">
	<div class="jumbotron" style="background-image: url(http://bryan.com/bryanleonard-v2/assets/img/hero.jpg);
 	...
 	<div class="jumbo-content">
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="#services" class="js-scroll">Resume</a></li>
							<li><a href="#contactus" class="js-scroll">Contact</a></li>  
						</ul>
					</div><!-- /.navbar-collapse -->
				</div><!-- /.container-fluid -->
			</nav>            
		...
		<div class="site-wrapper" id="about">
			...
			<div class="container padding-bottom">
				...
				<!-- Our Team -->
				<div class="bg-colorS padding-top-x2 padding-bottom">                        
					<div class="container">  
						...
						<div class="row">                                 
							...
							<div class="col-sm-12 col-md-6 text-center">
								<div class="team-inner">
									<a href="#">  
										<!-- Image -->                  
										<img src="assets/img/ghost.gif" class="img-circle" alt="Bryan" style="margin: 0 auto;">                    
										<div class="team-caption">
											...
											<div class="t-social-holder">
												<div class="team-social team-social-black">                                           
													...
													<a href="#"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa my-fa-twtr fa-stack-1x fa-inverse"></i></span></a>
													<a href="#"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa my-fa-lnkd fa-stack-1x fa-inverse"></i></span></a>
													<a href="#"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa my-fa-insgm fa-stack-1x fa-inverse"></i></span></a>
												</div>
											</div>
										</div>                                            
									</a>
							...
							<div class="col-sm-12 col-md-6 padding-top">
								<div class="team-details team-details-black">
									...
									<!-- Name -->                                                                                        
									<h3>Bryan Leonard</h3>   
									<!-- <p>I do work and stuff.</p>                                                             -->
								</div>
								<p>I'm a web designer and front-end web developer out of Akron, Ohio.</p>
								<p>After working at a Fortune 100 company for more than 12 years, I decided it was time for a change. I now work for Dealer Tire, LLC in Cleveland as a software developer and design lead within my team. It's a fun job with lots of challenges, freedom, and opportunities to grow in my skillset as well as share my knowledge and develop others.</p>
							</div>                                                            
...
hi
			...
			<section class="bg-color padding-bottom padding-top-x2">
				<div class="container">                                                        
					...
					<div class="row">
						<div class="col-md-6">
							<img src="assets/img/larx.png" alt="Specifie an alternate text for an image" class="img-responsive">    
						</div>
							...
							<ul>
								...
								<li class="cbp-item ideas motion">
									<a href="blog-posts/post1.html" class="cbp-caption cbp-singlePage">
										<!-- Blog Image -->
										<div class="cbp-caption-defaultWrap">
											<img src="assets/img/blog/blog_1.jpg" alt="Specifie an alternate text for an image">                    
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
								...
								<li class="cbp-item house-design decoration">
									<a href="blog-posts/post2.html" class="cbp-caption cbp-singlePage">
										<!-- Blog Image -->
										<div class="cbp-caption-defaultWrap">
											<img src="assets/img/blog/blog_2.jpg" alt="Specifie an alternate text for an image">                    
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
								...
								<li class="cbp-item ideas motion">
									<a href="blog-posts/post3.html" class="cbp-caption cbp-singlePage">
										<!-- Blog Image -->
										<div class="cbp-caption-defaultWrap">
											<img src="assets/img/blog/blog_3.jpg" alt="Specifie an alternate text for an image">                    
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
		...
		<div class="f-action" id="contactus">
			<a href="#" class="f-cta f-cta-black" data-toggle="modal" data-target="#myModal">Let's work together!</a>
		</div>
...
<?php
	...
	echo "<span>All content &copy; " . $today . " Bryan Leonard unless otherwise noted.</span>";
?>                       
					</div>                      
