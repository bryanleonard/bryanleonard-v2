(function ($, window, document, undefined) {
	...
	=============================================== */
		...
		// jQuery('.tp-bannerZ').show().revolution(
		// {
		// 	dottedOverlay:"none",
		// 	delay:9000,
		// 	startwidth:1170,
	...
	=============================================== */
		...
		var $jumbo = $('.jumbo');
		var $jumboText = $('.jumbo-text');
		var screenHeight = ($(window).height() - $('.header').height()).toString();
	...
	$(".navbar ul li a[href^='#'], .js-scroll").on('click', function(e) {
		e.preventDefault();
	...
	=============================================== */
		...
		function initialize() {
			var myLatlng = new google.maps.LatLng(41.081445, -81.519005); // Change your location Latitude and Longitude 
			var mapOptions = {
			zoom: 15,
			center: myLatlng
		}
